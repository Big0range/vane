...
<template>
  <div class="dashboard-container">
    <h1 @click="download" class="demo">下载示例</h1>
    <!-- github角标 -->
        ...
        <div class="flex flex-wrap justify-between">
          <div class="flex items-center">
            ...
            <span class="ml-[10px] text-[16px]">
              {{ userStore.allUserInfo.username }}
            </span>
          </div>
...
.demo {
  @apply aaa py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75;
}
.dashboard-container {
  position: relative;
  padding: 24px;
