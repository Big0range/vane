...
| Name | Type | Description | | --------- | ------------------------------ | ---------------------------- | ------ | | children? | `Array<MenuOption>` | Child menu options. | | disabled? | `boolean` | Whether to disable the item. | | extra? | `string \| (() => VNodeChild)` | Extra content. | | icon? | `() => VNodeChild` | Icon render function. | | key | `string` | Unique identifier. | | label | `string \| (() => VNodeChild)` | Label content. | | show? | `boolean` | Whether to show the item. | 2.32.2 |
